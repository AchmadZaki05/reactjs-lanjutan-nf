        ...
        <div className="max-w-2xl px-4 py-8 mx-auto lg:py-16">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex items-center space-x-4">
              <button
                type="submit"
                className="text-white bg-indigo-700 border border-indigo-700 hover:bg-indigo-600 hover:shadow-md hover:-translate-y-0.5 focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center transition-all duration-200 ease-in-out dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800"
              >
                Save Data
              </button>
            </div>
